...
write_rds(prep_data_study_2,here("Data/Processed/Other/prep_data_study_2.rds"))

#----------------------------------------------------------#
# 3. Rarefy data ------------------------------------------
#----------------------------------------------------------#

rarefied_prep_data_study_2 <- 
  prep_data_study_2 %>%  
...
write_rds(rarefied_prep_data_study_2,here("Data/Processed/Other/rarefied_prep_data_study_2.rds"))

#----------------------------------------------------------#
# 4. Estimate richness  -----------------------------------
#----------------------------------------------------------# 

richnesss_estimate_2 <- estimate_richness(rarefied_prep_data_study_2)

#----------------------------------------------------------#
# 5. Plot site-based richness with age  -------------------
#----------------------------------------------------------# 

richnesss_estimate_2 %>% 
