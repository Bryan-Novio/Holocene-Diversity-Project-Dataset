...
prepared_data_for_richness_estimation <- read_rds(here("Outputs/Data/paper_1_study_4/prepared_data_for_richness_estimation_study_4.rds"))
...
write_rds(rarefied_data, here("Outputs/Data/paper_1_study_4/rarefied_data_study_4.rds"))
#----------------------------------------------------------#