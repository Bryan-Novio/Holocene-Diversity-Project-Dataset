...
prep_data_study_2 <- read_rds(here("Data/Processed/Other/prep_data_study_2.rds"))
...
prep_data_study_2_ages_pollen <- prep_data_study_2 |> 
...
harmonized_data_study_2_family <- harmonize_taxa(prep_data_study_2, prep_data_study_2_ages_pollen,"level_5")
harmonized_data_study_2_genus <- harmonize_taxa(prep_data_study_2, prep_data_study_2_ages_pollen,"level_6")
harmonized_data_study_2_species <- harmonize_taxa(prep_data_study_2, prep_data_study_2_ages_pollen,"level_7") 
