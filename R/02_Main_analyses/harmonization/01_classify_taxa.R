...
#----------------------------------------------------------#
# 5. Save  neotoma_names   and class_taxa as RDS file -----
#----------------------------------------------------------#

write_rds(classified_taxa, here("Data/Processed/Data_harmonised/classified_taxa_neotoma_p1_all_subset.rds"))
