...
pollen_data_study1_sample <- 
  read_rds(here("Data/Paper_1/data_subset/data_p1_s1_sub_region_sample.rds")) 

pollen_data_study1_sample_unique <- 
  pollen_data_study1_sample %>% 
  distinct(sample_id)   # 45,455 samples
